...
@Autonomous(name = "RL - Park")
public class RLParkExecutor extends AutonomousExecutor {
    ...
    public ActionSequence getActionSequence() {
        return new ParkSequence(BaseHardware.Team.RED, BaseHardware.StartingPosition.LEFT);
    }
}
