...
@Autonomous(name="RL -> Bridge", group="Parking")
public class RLBridge extends AutonomousExecutor {
    @Override
    ...
    public ActionSequence getActionSequence() {
        return new ParkingSequence(SkyStoneRobotHardware.SkystoneStartingPosition.RIGHT_LEFT, ParkingSequence.ParkingDestination.BRIDGE);
    }
}
