...
public class DirectionalMoveAction implements Action {
    ...
    public boolean doAction(RobotHardware hardware) {
        ...
        hardware.opMode.telemetry.addData("All Avg", allAvg);
        hardware.opMode.telemetry.addData("LR Avg", leftRightAvg);
        hardware.opMode.telemetry.addData("RL Avg", rightLeftAvg);
