...
@Autonomous(name="LL -> Wall", group="Parking")
public class LLWall extends AutonomousExecutor {
    @Override
    ...
    public ActionSequence getActionSequence() {
        return new ParkingSequence(SkyStoneRobotHardware.SkystoneStartingPosition.LEFT_LEFT, ParkingSequence.ParkingDestination.WALL);
    }
}