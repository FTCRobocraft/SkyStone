...
@Autonomous(name="RR -> Wall", group="Parking")
public class RRWall extends AutonomousExecutor {
    @Override
    ...
    public ActionSequence getActionSequence() {
        return new ParkingSequence(SkyStoneRobotHardware.SkystoneStartingPosition.RIGHT_RIGHT, ParkingSequence.ParkingDestination.WALL);
    }
}