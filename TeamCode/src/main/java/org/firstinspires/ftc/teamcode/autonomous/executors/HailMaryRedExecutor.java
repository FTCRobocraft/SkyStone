...
@Autonomous(name="HAIL MARY BUT RED", group="hm")
public class HailMaryRedExecutor extends AutonomousExecutor {
    @Override
    ...
    public ActionSequence getActionSequence() {
        return new HailMarySequence(BaseHardware.Team.RED, true,false);
    }
