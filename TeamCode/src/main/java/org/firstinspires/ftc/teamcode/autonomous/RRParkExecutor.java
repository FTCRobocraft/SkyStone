...
@Autonomous(name = "RR - Park")
public class RRParkExecutor extends AutonomousExecutor {
    ...
    public ActionSequence getActionSequence() {
        return new ParkSequence(BaseHardware.Team.RED, BaseHardware.StartingPosition.RIGHT);
    }
